...
def login_for_access_token(
    ...
    token_data = {
        ...
        "email": user.email,
        "perfil": user.perfil_rel.nome if user.perfil_rel else "Sem Perfil",
        "permissoes": user.perfil_rel.permissoes if user.perfil_rel else {},
        "cor_sidebar": business.cor_sidebar
    }
