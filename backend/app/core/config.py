...
class Settings(BaseSettings):
    ...
    # Configurações do Responsável Técnico (NFe)
    RESP_TECNICO_CNPJ: Optional[str] = None
    RESP_TECNICO_CONTATO: Optional[str] = None
    RESP_TECNICO_EMAIL: Optional[str] = None
    RESP_TECNICO_FONE: Optional[str] = None
    RESP_TECNICO_ID_CSRT: Optional[str] = None
    RESP_TECNICO_CSRT: Optional[str] = None

    RESP_TECNICO_ID_CSRT_HOMOLOGACAO: Optional[str] = None
    RESP_TECNICO_CSRT_HOMOLOGACAO: Optional[str] = None
