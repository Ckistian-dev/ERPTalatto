...
INSERT INTO `info_empresa` VALUES (1,'29987353000109','TALATTO INDUSTRIA E COMERCIO LTDA','TALATTO INDUSTRIA E COMERCIO LTDA','9088814603','986272','R ALBERTO DALCANALE','3103','AO LADO DA TWR TRANSPORTADORA','JARDIM ANAPOLIS','4127700','TOLEDO','PR','85905415','2229399',1,0,'PR','58414763000169','Cristian','cris.talatto@gmail.com','45999861237','2025-07-28 14:13:16','2025-07-18 12:56:47');
/*!40000 ALTER TABLE `info_empresa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `meli_configuracoes`
--
...
CREATE TABLE `meli_configuracoes` (
  `id` int NOT NULL,
  `aceite_automatico_pedidos` tinyint(1) DEFAULT '0',
  `cliente_padrao_id` int DEFAULT NULL,
  `vendedor_padrao_id` int DEFAULT NULL,
...
--
-- Dumping data for table `meli_configuracoes`
--

LOCK TABLES `meli_configuracoes` WRITE;
/*!40000 ALTER TABLE `meli_configuracoes` DISABLE KEYS */;
INSERT INTO `meli_configuracoes` VALUES (1,0,1,1,'Aguardando Faturamento','2025-07-30 08:24:16');
/*!40000 ALTER TABLE `meli_configuracoes` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `pedidos` VALUES (1005,'Em Processamento (NF-e)','18/07/2025','25/07/2025',106,'Cristian Gabriel Kist',105,'TALATTO VAREJO LTDA','Instagram','Contratação do Frete por conta de Terceiros',107,'RODONAVES TRANSPORTES E ENCOMENDAS LTDA',79.00,00000335.66,14.66,400.00,'[{\"produto\": \"### PERFIL DE INSTALACAO MADEIRA PLASTICA 270X7X3CM\", \"subtotal\": 335.66, \"variacao\": \"Amêndoa\", \"produto_id\": 204, \"variacao_id\": \"Amêndoa\", \"tabela_preco\": \"Revendedor\", \"tabela_preco_id\": \"Revendedor\", \"quantidade_itens\": 1}]','[{\"tipo\": \"Pix\", \"parcelas\": 1, \"valor_pix\": 200.0, \"valor_boleto\": 0.0, \"valor_parcela\": 0.0, \"valor_dinheiro\": 0.0}, {\"tipo\": \"Parcelamento\", \"parcelas\": 2, \"valor_pix\": 0.0, \"valor_boleto\": 0.0, \"valor_parcela\": 100.0, \"valor_dinheiro\": 0.0}]','','{\"ordens_producao\": [], \"data_programacao\": \"2025-07-23T13:24:40.321Z\", \"retiradas_estoque\": [{\"origem\": {\"cor\": \"Azul\", \"rua\": \"A\", \"lote\": \"CO225\", \"nivel\": \"1\", \"numero\": \"3103\", \"deposito\": \"Talatto Painéis\"}, \"produto_id\": 204, \"quantidade\": 1, \"produto_nome\": \"### PERFIL DE INSTALACAO MADEIRA PLASTICA 270X7X3CM\"}]}','2025-07-18 14:55:17','NaN-NaN-NaN NaN:NaN:NaN','1.0','{\"rua\": \"A\", \"numero\": 2, \"nivel\": 3, \"cor\": \"Amarelo\"}','2025-07-28 11:12:05','Teste',NULL,NULL,NULL,NULL,'REJEITADO',NULL,NULL,NULL,'<env:Envelope xmlns:env=\'http://www.w3.org/2003/05/soap-envelope\'><env:Body xmlns:env=\'http://www.w3.org/2003/05/soap-envelope\'><nfeResultMsg xmlns=\'http://www.portalfiscal.inf.br/nfe/wsdl/NFeAutorizacao4\'><retEnviNFe versao=\'4.00\' xmlns=\'http://www.portalfiscal.inf.br/nfe\'><tpAmb>2</tpAmb><verAplic>PR-v4_9_15</verAplic><cStat>108</cStat><xMotivo>Servico Paralisado Momentaneamente (curto prazo)</xMotivo><cUF>41</cUF><dhRecbto>2025-07-28T11:35:49-03:00</dhRecbto></retEnviNFe></nfeResultMsg></env:Body></env:Envelope>',NULL,NULL,NULL),(1006,'Programação','21/07/2025','28/07/2025',106,'Cristian Gabriel Kist',105,'TALATTO VAREJO LTDA','Instagram','Contratação do Frete por conta de Terceiros',107,'RODONAVES TRANSPORTES E ENCOMENDAS LTDA',78.97,00000000.00,14.63,400.00,'[{\"produto\": \"### PERFIL DE INSTALACAO MADEIRA PLASTICA 270X7X3CM\", \"subtotal\": 335.66, \"variacao\": \"Amêndoa\", \"produto_id\": 204, \"variacao_id\": \"Amêndoa\", \"tabela_preco\": \"Revendedor\", \"tabela_preco_id\": \"Revendedor\", \"quantidade_itens\": 1}]','[{\"tipo\": \"Boleto\", \"parcelas\": 1, \"valor_pix\": 0.0, \"valor_boleto\": 200.0, \"valor_parcela\": 0.0, \"valor_dinheiro\": 0.0}, {\"tipo\": \"Parcelamento\", \"parcelas\": 2, \"valor_pix\": 0.0, \"valor_boleto\": 0.0, \"valor_parcela\": 100.0, \"valor_dinheiro\": 0.0}]','','{\"ordens_producao\": [], \"data_programacao\": \"2025-07-23T13:20:38.738Z\", \"retiradas_estoque\": [{\"origem\": {\"cor\": \"Azul\", \"rua\": \"A\", \"lote\": \"CO225\", \"nivel\": \"1\", \"numero\": \"3103\", \"deposito\": \"Talatto Painéis\"}, \"produto_id\": 204, \"quantidade\": 1, \"produto_nome\": \"### PERFIL DE INSTALACAO MADEIRA PLASTICA 270X7X3CM\"}]}','2025-07-21 11:52:29','24/07/2025','1.0',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `produtos` VALUES (204,'807','7898735308071','### PERFIL DE INSTALACAO MADEIRA PLASTICA 270X7X3CM','UN','Ativo',300,'Mercadoria de Revenda','[\"Amêndoa\", \"Areia\", \"Branco\", \"Carvalho\", \"Cru\", \"Freijo\", \"Gianduia\", \"Preto\", \"Peroba\", \"Marmorizado\", \"Imbuia\"]','[1]','Perfil','Madeira Plástica',NULL,NULL,NULL,NULL,'[\"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS6wDa9WAfCGiruztnnOCHgwDrIxldd4mPC1Q&s\"]','39259090','Nacional','7898735308071','7898735308071',NULL,NULL,'{\"Revendedor\": 335.66, \"Venda Direta\": 354.67, \"Mercado Livre\": 300.05}','1','Embalagem Padrão Ripados',15000,10,15.00,15.00,272.00,223.56,NULL,1,'',NULL,'','','[]','[]',NULL,NULL,NULL,NULL,'[]',NULL,'2025-07-18 14:02:52',0),(205,'471','7898735302130','PAINEL RIPADO VERSATIL VERTICAL 27 CM - AMENDOA','UN','Ativo',560,'Mercadoria de Revenda','[\"Amêndoa\", \"Areia\", \"Branco\", \"Carvalho\", \"Cru\", \"Freijo\", \"Gianduia\", \"Imbuia\", \"Marmorizado\", \"Peroba\", \"Preto\"]','[1]','Painél',NULL,NULL,NULL,NULL,NULL,'[\"https://m.media-amazon.com/images/I/61bVwLa3FcL.jpg\"]','39206299','Nacional','7898735302130','7898735302130',NULL,NULL,'{\"Mercado Livre\": \"\"}',NULL,NULL,15000,10,27.00,15.00,272.00,47.00,NULL,1,'',NULL,'','','[]','[]',NULL,NULL,NULL,NULL,'[]',NULL,'2025-07-29 14:02:01',1);
...
-- Dump completed on 2025-07-30 10:01:59
