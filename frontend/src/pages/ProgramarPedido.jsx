...
export default function Listapedidos() {
    ...
    const buscarpedidos = async () => {
        ...
        try {
            ...
            const res = await axios.get('http://localhost:8000/pedidos/paginado', { params })
    ...
    useEffect(() => {
        ...
        if (tipo && !opcoesDropdown[filtroRapidoColuna]) {
            axios.get(`http://localhost:8000/opcoes/${tipo}`)
                .then(res => {
    ...
    const atualizarPedido = async (alteracoes = {}) => {
        ...
        try {
            const res = await axios.get(`http://localhost:8000/pedidos/paginado`, {
                params: {
            ...
            await axios.put(`http://localhost:8000/pedidos/${pedidoSelecionado.id}`, payload);
