...
import ModalDespachoPedido from '@/components/modals/ModalDespachoPedido';
...
export default function Listapedidos() {
    ...
    const [ordenacaoColuna, setOrdenacaoColuna] = useState('id'); // Alterado para corresponder ao layout
    ...
    const exportarCSV = async () => {
        try {
            ...
            link.setAttribute('download', 'pedidos_expedicao.csv');
    ...
    const atualizarPedido = async (alteracoes = {}) => {
        ...
        try {
            ...
            const payload = {
                ...
                observacao: pedidoCompleto.observacao || "", situacao_pedido: pedidoCompleto.situacao_pedido,
                data_finalizacao: pedidoCompleto.data_finalizacao || null, ordem_finalizacao: pedidoCompleto.ordem_finalizacao || null,
    ...
    return (
        <div className="p-6">
            <h1 className="text-2xl sm:text-3xl font-bold mb-6 text-gray-800">Pedidos para Despacho</h1>
            <div className="w-auto overflow-auto">
                <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        ...
                        <button onClick={() => { if (!pedidoSelecionado) exibirAviso("Selecione um pedido!"); else setMostrarModalDespachar(true); }} className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded flex items-center gap-2"><FaTruck />Despachar Pedido</button>
                    </div>
                </div>
                    ...
                    <table className="w-full table-auto whitespace-nowrap">
                        ...
                        <tbody className="text-sm">
                            {loading ? (<tr><td colSpan={colunasVisiveis.length} className="text-center p-8">Carregando...</td></tr>)
                                : pedidos.length === 0 ? (<tr><td colSpan={colunasVisiveis.length} className="text-center p-8 text-gray-500">Nenhum pedido em expedição.</td></tr>)
                                    : pedidos.map(pedido => (
            ...
            {mostrarModalDespachar && (
                <ModalDespachoPedido
                    ...
                    onConfirmar={async (dadosDespacho) => {
                        try {
                            const alteracoesComSituacao = { ...dadosDespacho, situacao_pedido: 'Despachado' };
