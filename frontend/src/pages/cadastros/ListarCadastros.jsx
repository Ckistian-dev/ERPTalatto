...
export default function Listacadastros() {
    ...
    const editarcadastro = () => {
        if (!cadastroSelecionado) return exibirAviso('Você deve selecionar um cadastro primeiro!');
            ...
            <div className="w-auto overflow-auto">
                ...
                <div className="flex flex-wrap justify-between items-center mb-4 gap-2">
                    ...
                    <div className="flex gap-2">
                        ...
                        {/* Botão editar */}
                        <ButtonComPermissao type="button" onClick={editarcadastro} permissoes={["admin"]} className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded flex items-center gap-2"><FiEdit />Editar</ButtonComPermissao>
                    ...
                    <div className="fixed inset-0 bg-black bg-opacity-40 backdrop-blur-sm flex items-center justify-center z-50">
                        <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md w-full text-center border border-gray-200 animate-fade-in">
                            ...
                            <p className="text-gray-600 mb-6">
                                Deseja realmente {acaoPendente === 'editar' ? 'editar' : 'excluir'} o cadastro{' '}
                                <span className="font-bold text-gray-900">{cadastroSelecionado?.nome_razao}</span>?
                            </p>
                                    ...
                                    <tr>
                                        <td colSpan={colunasVisiveis.length}>
                                            <div className="flex items-center pl-[63vh] h-[63vh]">
                                                <span className="text-gray-500 text-lg">Nenhum cadastro encontrado.</span>
                                            </div>
                                        </td>
                                    </tr>
                                ) : (
                                    <>
                                        {cadastros.map((cadastro, i) => (
                                            <tr
                                                ...
                                                className={`cursor-pointer ${cadastroSelecionado?.id === cadastro.id ? 'bg-gray-100' : ''}`}
                                            >
                                                {colunasVisiveis.map((coluna) => (
                                        ...
                                        {cadastros.length < 15 &&
                                            Array.from({ length: 15 - cadastros.length }).map((_, idx) => (
