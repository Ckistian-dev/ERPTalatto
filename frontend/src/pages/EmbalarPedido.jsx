...
export default function Listapedidos() {
    ...
    const atualizarPedido = async (alteracoes = {}) => {
        ...
        try {
            ...
            // const alteracoesFiltradas = { ...alteracoes }; // Não utilizado, pode ser removido
        ...
        <div className="p-6">
            ...
            {mostrarModalExpedicao && (
                <ModalExpedicaoPedido
                    ...
                    API_URL={API_URL} // Passa API_URL para o ModalExpedicaoPedido
                />
            )}
        </div>
    )
