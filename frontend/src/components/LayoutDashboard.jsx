      ...
      <aside className={`${sidebarAberta ? 'w-64' : 'w-20'} bg-gray-800 text-gray-300 p-4 space-y-4 transition-[width] duration-300 overflow-y-auto`}>
        ...
        <nav className="space-y-2">
          ...
          {verificarPermissao(usuario, ['admin']) && (
            <SidebarItem icone={<FaStore />} titulo="Integrações" aberto={menuAberto === 'integracoes'} toggle={() => toggleMenu('integracoes')} submenu={["Focus NFE", "Mercado Livre", "Tray", "Intelipost"]} sidebarAberta={sidebarAberta} links={["/integracoes/focus", "/integracoes/mercadolivre", "/integracoes/tray", "/integracoes/intelipost"]} location={location} />
          )}
        </nav>
      </aside>
